...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<div class="clearfix">
			...
			<div class="pull-right">
				...
				<?php if(App\Http\Controllers\LoginController::can_access('UserGroups', 'add')): ?>
				<a class="btn btn-success btn-xs" href="<?php echo e(URL::to('/usergroups/add')); ?>" title="Add Item" role="button"><span class="fa fa-plus"></span> Add Item</a>
	        	<?php endif; ?>
	...
	<div class="panel-body">
		<?php echo Form::open(array('name' => 'search_form', 'url' => URL::to('usergroups'), 'class'=>'form-inline', 'role' => 'form')); ?>
	...
	<div class="table-responsive">
		...
		<tbody>
		    ...
		    <?php $i++; ?>
		    <?php echo $__env->make('usergroups.index_row', ['row' => $row, 'i' => $i], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		    <?php endforeach; ?>
		</tbody>
		</table>
	</div>
