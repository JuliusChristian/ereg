	...
	<div class="panel-body">
		<?php echo Form::model($row, array('name' => 'input_form', 'url' => URL::to('events/'.$id.'/save'), 'class' => 'form', 'role' => 'form', 'files' => true)); ?>
			...
			<div class="form-group">
				...
				<?php echo Form::date('event_from', NULL, array('class' => 'form-control input-sm', 'placeholder' => 'Start Date', 'maxlength' => '10' )); ?>
			...
			<div class="form-group">
				...
				<?php echo Form::date('event_to', NULL, array('class' => 'form-control input-sm', 'placeholder' => 'End Date', 'maxlength' => '10', 'accpet' => 'image/*')); ?>
