    ...
    public function getBarcode($code, $type, $widthFactor = 2, $totalHeight = 30, $color = 'black')
    {
        ...
        foreach ($barcodeData['bars'] as $bar) {
            ...
            if ($bar['drawBar']) {
                ...
                // draw a vertical bar
                $html .= '<div class="barcode-bar" style="background-color:' . $color . ';width:' . $barWidth . 'px;height:' . $barHeight . 'px;position:absolute;left:' . $positionHorizontal . 'px;top:' . $positionVertical . 'px;">&nbsp;</div>' . "\n";
            }
